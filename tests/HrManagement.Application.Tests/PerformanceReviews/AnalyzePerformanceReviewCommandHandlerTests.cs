...
public class AnalyzePerformanceReviewCommandHandlerTests
{
    ...
    {
        var handler = new AnalyzePerformanceReviewCommandHandler(Mock.Of<ILlmService>());
    ...
    public async Task Handle_ShouldCallLlmService_WithValidInput()
    {
        ...
        var handler = new AnalyzePerformanceReviewCommandHandler(mockLlmService.Object);
