...
{
    [Fact]
    public async Task Handle_ShouldRejectLeaveRequest_WhenValidCommand()
    {
        ...
        var handler = new RejectLeaveRequestCommandHandler(leaveRequestRepository.Object, unitOfWork.Object, Mock.Of<IEmailService>());
        var command = new RejectLeaveRequestCommand(leaveRequest.Id, reviewerId, "Denied");
    ...
    public async Task Handle_ShouldThrowNotFoundException_WhenLeaveRequestDoesNotExist()
    {
        ...
        var handler = new RejectLeaveRequestCommandHandler(leaveRequestRepository.Object, unitOfWork.Object, Mock.Of<IEmailService>());
        var command = new RejectLeaveRequestCommand(Guid.NewGuid(), Guid.NewGuid(), "Denied");
